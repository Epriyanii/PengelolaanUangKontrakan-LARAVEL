        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow rounded">
                    <div class="card-body">
                    <form action="{{ route('kontrakans.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('no_kn') is-invalid @enderror" name="no_kn" value="{{ old('no_kn') }}" placeholder="Masukkan Nomor Kontrakan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('status_kn') is-invalid @enderror" name="status_kn" value="{{ old('status_kn') }}" placeholder="Masukkan Status Kontrakan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('harga_kn') is-invalid @enderror" name="harga_kn" value="{{ old('harga_kn') }}" placeholder="Masukkan Harga Kontrakan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('id_penghuni') is-invalid @enderror" name="id_penghuni" value="{{ old('id_penghuni') }}" placeholder="Masukkan Nomor KTP Penghuni">
